# Well-Architected Assessment — huaweicloud-hss-ops
...
| `product` | `hss` |
| Finding `id` pattern | `hss-{rel|sec|cost|eff}-NNN` |
...
```json
{
  ...
  "trace": {
    "commands": [
      "hcloud hss read-only-list --region cn-north-4 (HW_SECRET_ACCESS_KEY=<masked>)"
    ],
    "request_ids": [
