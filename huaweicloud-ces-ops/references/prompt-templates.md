...

{
  ...
  "result": { "status": "success|failure|aborted",
              "resource_id": "...",
              "post_state": { ... } },
  "safety_block": null | "missing_confirmation" | "active_alarm_firing"
                 | "last_rule_for_metric" | "no_notification"
                 | "eval_period_too_fast" | "resource_not_found"
                 | "zero_threshold" | "shared_dashboard"
                 | "credential_leak",
  "iter": <int>
}
...
2. If alarm_actions contain phone numbers or email addresses, replace with `<pii-masked>`.
