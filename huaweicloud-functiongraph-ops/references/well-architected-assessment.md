...
| Finding `id` pattern | `functiongraph-{rel|sec|cost|eff}-NNN` |
...
```json
{
  ...
  "trace": {
    "commands": [
      "hcloud functiongraph read-only-list --region cn-north-4 (HW_SECRET_ACCESS_KEY=<masked>)"
    ],
    "request_ids": [
