...
func runScan(args []string) error {
	...
	case "-h", "--help", "help":
		fmt.Fprintln(os.Stdout, "hwcloud-skillcheck scan secret <trace|summary|alarm-plan> --root <dir> [--latest] [--include-fixture] [--json] [--self-check]")
		return nil
	default:
...
func runScanSecret(args []string) error {
	...
	fs := newFlagSet("hwcloud-skillcheck scan secret " + kind)
